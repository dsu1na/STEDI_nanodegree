...
customerlanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-das-nanod/customer/landing/"],
        "recurse": True,
    },
...
ConsentFilter_node1692637990378 = Filter.apply(
    frame=customerlanding_node1,
    f=lambda row: (not (row["shareWithResearchAsOfDate"] == 0)),
    transformation_ctx="ConsentFilter_node1692637990378",
)

# Script generated for node customer trusted
customertrusted_node3 = glueContext.write_dynamic_frame.from_options(
    frame=ConsentFilter_node1692637990378,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://stedi-das-nanod/customer/trusted/",
        "partitionKeys": [],
    },
